...
if (urlParam) {
  ...
  const playerBtn = document.querySelectorAll(`#${urlParam} button`);
  const footBtn = document.querySelectorAll(`#${urlParam} button`);
  const controls = document.getElementById(urlParam);
  const controlBtn = document.querySelectorAll(`#${urlParam} button`);
